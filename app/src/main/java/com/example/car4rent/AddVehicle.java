...
public class AddVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_vehicle);
            ...
            etColor = findViewById(R.id.et_colorvehicle);
            etModel = findViewById(R.id.et_modelvehicle);
            etYear = findViewById(R.id.et_yearvehicle);
            etLicencePlate = findViewById(R.id.et_licenceplate);
            addVehicle = findViewById(R.id.bt_addvehicle);
